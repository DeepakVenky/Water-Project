...
#mydf2.to_csv('F:/WaterCsv/bla_nodes.csv')
# 
# 
...
print(mydf3)
# #writer = pd.ExcelWriter('C:/Users/Iswarya/Documents/test.xlsx')
#mydf3.to_csv('F:/WaterCsv/bla_coords.csv')
# =============================================================================
...
for i in range(es+1,ee):
    if isinstance(df.iloc[i][1], (int, float, complex)):
        ...
        l4.append(df.iloc[i][5]*df.iloc[i][4])
mydf1 = pd.DataFrame(
    {'Id': l1,
     'Source': l2,
     'Target': l3,
...
#mydf1.drop('Id')
#writer = pd.ExcelWriter('C:/Users/Iswarya/Documents/test.xlsx')
mydf1.to_csv('F:/WaterCsv/bla_pipeXdia.csv')
