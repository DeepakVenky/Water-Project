# -*- coding: utf-8 -*-
"""
Created on Sun Sep 23 14:33:18 2018
...
df1=pd.read_csv('C:/Users/Iswarya/Documents/KL_pipeXdia.csv')
mydf=pd.read_csv('C:/Users/Iswarya/Documents/KL_latlon.csv')
g = Graph(447)
#print(mydf['Id'])
g.addallid(mydf['Id'])
#print(g.id)
...
print(df3)
df3.to_csv('C:/Users/Iswarya/Documents/KL_MstCap.csv')
